                    ...
                    <div class="ibox-content">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="<?php echo ($blog["title"]); ?>" placeholder="请输入博文标题" class="form-control" name="title" id="title">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="<?php echo ($blog["author"]); ?>" placeholder="请输入博文作者" class="form-control" name="author" id="author">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
