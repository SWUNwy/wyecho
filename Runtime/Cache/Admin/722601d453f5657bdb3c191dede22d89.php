                ...
                <div class="ibox-content">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="uname" id="uname" value="<?php echo ($list["uname"]); ?>" placeholder="请填写用户名">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="password" class="form-control" name="pwd"  id="pwd" value="<?php echo ($list["pwd"]); ?>" placeholder="请填写密码">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="radio i-checks">
                                    <label><input type="radio" value="1" name="status" id="status" <?php if(($list['status'] == 1)): ?>checked="checked"<?php endif; ?> > <i></i>启用</label>
                                    <label><input type="radio" value="0" name="status" id="status" <?php if(($list['status'] == 0)): ?>checked="checked"<?php endif; ?> > <i></i>禁用</label>
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
