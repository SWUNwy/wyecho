                    ...
                    <div class="ibox-content">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" id="title" placeholder="请填写权限名称" value="<?php echo ($list["title"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name" id="name" placeholder="请填写控制器方法，例如Admin/Index/index" value="<?php echo ($list["name"]); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
