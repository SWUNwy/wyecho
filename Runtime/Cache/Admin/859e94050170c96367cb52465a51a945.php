                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span>
                                <?php if(($images == '')): ?><img alt="image" class="img-circle" src="/wyecho/public/Admin/img/profile_small.jpg" />
                                <?php else: ?>
...
<!--                         <?php if(in_array('32',$auth)||$auth==''){ ?>
    ...
    <script src="/wyecho/public/Admin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/wyecho/public/Admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="/wyecho/public/Admin/js/plugins/layer/layer.min.js"></script>
    <script src="/wyecho/public/Admin/js/hplus.min862f.js?v=4.1.0"></script>
