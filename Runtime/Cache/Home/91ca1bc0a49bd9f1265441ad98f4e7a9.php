                ...
                <ul class="layui-nav fly-nav-user">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="<?php echo U('User/set');?>"><i class="layui-icon">&#xe620;</i>基本设置</a></dd>
                            <dd><a href="<?php echo U('User/message');?>"><i class="iconfont icon-tongzhi" style="top: 4px;"></i>我的消息</a></dd>
                            <dd><a href="<?php echo U('user/index');?>"><i class="layui-icon" style="margin-left: 2px; font-size: 22px;">&#xe68e;</i>我的主页</a></dd>
